...
_CREATESTOREREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='store', full_name='store.CreateStoreRequest.store', index=0,
...
_CREATESTOREREQUEST.fields_by_name['store'].message_type = _STOREOBJECT
