...
_UPDATESUBSCRIPTIONREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="UpdateSubscriptionRequest.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="is_active",
            full_name="UpdateSubscriptionRequest.is_active",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="expiration_date",
            full_name="UpdateSubscriptionRequest.expiration_date",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_DELETESUBSCRIPTIONREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="DeleteSubscriptionRequest.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
...
_READSUBSCRIPTIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="created_at",
            full_name="ReadSubscriptionResponse.created_at",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="updated_at",
            full_name="ReadSubscriptionResponse.updated_at",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
...
_READSUBSCRIPTIONLISTRESPONSE_SUBSCRIPTIONOBJECT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="ReadSubscriptionListResponse.SubscriptionObject.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="is_active",
            full_name="ReadSubscriptionListResponse.SubscriptionObject.is_active",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="expiration_date",
            full_name="ReadSubscriptionListResponse.SubscriptionObject.expiration_date",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="created_at",
            full_name="ReadSubscriptionListResponse.SubscriptionObject.created_at",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="updated_at",
            full_name="ReadSubscriptionListResponse.SubscriptionObject.updated_at",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
...
_READSUBSCRIPTIONLISTRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="ReadSubscriptionListResponse.subscription_list",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _READSUBSCRIPTIONLISTRESPONSE_SUBSCRIPTIONOBJECT,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_UPDATESUBSCRIPTIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="msg",
            full_name="UpdateSubscriptionResponse.msg",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_DELETESUBSCRIPTIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="msg",
            full_name="DeleteSubscriptionResponse.msg",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_READSUBSCRIPTIONLISTRESPONSE_SUBSCRIPTIONOBJECT.containing_type = (
    _READSUBSCRIPTIONLISTRESPONSE
)
_READSUBSCRIPTIONLISTRESPONSE.fields_by_name[
    "subscription_list"
].message_type = _READSUBSCRIPTIONLISTRESPONSE_SUBSCRIPTIONOBJECT
...
DESCRIPTOR.message_types_by_name[
    "ReadSubscriptionListResponse"
] = _READSUBSCRIPTIONLISTRESPONSE
DESCRIPTOR.message_types_by_name[
    "UpdateSubscriptionResponse"
] = _UPDATESUBSCRIPTIONRESPONSE
DESCRIPTOR.message_types_by_name[
    "DeleteSubscriptionResponse"
] = _DELETESUBSCRIPTIONRESPONSE
...
ReadSubscriptionListRequest = _reflection.GeneratedProtocolMessageType(
    "ReadSubscriptionListRequest",
    (_message.Message,),
    {
...
ReadSubscriptionListResponse = _reflection.GeneratedProtocolMessageType(
    "ReadSubscriptionListResponse",
    (_message.Message,),
    {
        "SubscriptionObject": _reflection.GeneratedProtocolMessageType(
            "SubscriptionObject",
            (_message.Message,),
            {
