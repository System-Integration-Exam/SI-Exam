...
_CREATEVINYLREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='CreateVinylRequest.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='artist', full_name='CreateVinylRequest.artist', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='genre', full_name='CreateVinylRequest.genre', index=2,
