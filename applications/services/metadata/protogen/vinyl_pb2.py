...
_CREATEVINYLRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="vinyl",
            full_name="CreateVinylResponse.vinyl",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_GETALLVINYLRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="vinyls",
            full_name="GetAllVinylResponse.vinyls",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_CREATEVINYLRESPONSE.fields_by_name["vinyl"].message_type = _VINYLMESSAGE
...
GetAllVinylRequest = _reflection.GeneratedProtocolMessageType(
    "GetAllVinylRequest",
    (_message.Message,),
    {
...
GetAllVinylResponse = _reflection.GeneratedProtocolMessageType(
    "GetAllVinylResponse",
    (_message.Message,),
    {
...
VinylMessage = _reflection.GeneratedProtocolMessageType(
    "VinylMessage",
    (_message.Message,),
    {
